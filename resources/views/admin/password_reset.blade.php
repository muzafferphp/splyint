			...
			@csrf
              <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                  <a class="now-log-in font-q" href="{{route('admin.login')}}">Log in your account</a>
                </div>
                <div class="col-lg-6 col-sm-6">
                  <p class="now-register"> Not a member? <a class="font-q" href="{{route('admin.register')}}">Registration</a>
                  </p>
                </div>
