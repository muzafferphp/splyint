			...
			@csrf
              <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                  <a class="now-log-in font-q" href="{{route('login')}}">Log in your account</a>
                </div>
                <div class="col-lg-6 col-sm-6">
                  <p class="now-register"> Not a member? <a class="font-q" href="{{route('user.register')}}">Registration</a>
                  </p>
                </div>
